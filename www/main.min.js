...
$(document).ready(function(){"windows"===cordova.platformId&&(window.onerror=function(){return!0});$.ajaxSetup({timeout:TIMEOUT});ons.ready(function(){$("#iOSBackBtn").on("click.goBack",goBack);$("#settingsBtn").one("click",function(){$.getScript("settings/settings.js",function(){$("#settingsBtn").click(goToSettings);goToSettings()})});$("#acctBtn").click(openAcctPopover);ss=new cordova.plugins.SecureStorage(function(){console.info("Secure storage init complete!");ss.get(function(a){accountMetadata=
