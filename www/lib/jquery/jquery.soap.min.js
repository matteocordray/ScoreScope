...
data:this.toString(),contentType:c+"; charset=UTF-8"+(a.soap12?"; action="+a.action:""),xhrFields:{withCredentials:!0},beforeSend:function(){if(d.isFunction(a.beforeSend))return a.beforeSend.call(a.context,b)}})}};var h=function(a){this.typeOf="SOAPObject";this.name=a;this.ns={};this.attributes={};this._parent=null;this.children=[];this.value=void 0};h.prototype={attr:function(a,b){return a&&b||a&&""===b?(this.attributes[a]=b,this):a?this.attributes[a]:this.attributes},val:function(a){if(void 0===
a)return"true"===this.attr("xsi:nil")?null:this.value;null===a?this.attr("xsi:nil","true"):this.value=a;return this},addNamespace:function(a,b){this.ns[a]=b;return this},appendChild:function(a){a._parent=this;this.children.push(a);return a},newChild:function(a){a=new h(a);this.appendChild(a);return a},addParameter:function(a,b){var c=new h(a);c.val(b);this.appendChild(c);return this},hasChildren:function(){return 0<this.children.length?!0:!1},find:function(a){if(this.name===a)return this;for(var b=
0;b<this.children.length;b++){var c=this.children[b].find(a);if(c)return c}},end:function(){return this.parent()},parent:function(){return this._parent},toString:function(){var a=[],b={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&apos;"},c;a.push("<"+this.name);for(var g in this.ns)a.push(" xmlns:"+g+'="'+this.ns[g]+'"');for(var e in this.attributes)"string"===typeof this.attributes[e]&&a.push(" "+e+'="'+this.attributes[e]+'"');a.push(">");if(this.hasChildren())for(var d in this.children)g=
this.children[d],"object"===typeof g&&"SOAPObject"===g.typeOf&&a.push(g.toString());void 0!==this.value&&("string"===typeof this.value?c=this.value.match(/<!\[CDATA\[\s\S\]*\]>/)?this.value:this.value.replace(/[<>&"']/g,function(a){return b[a]}):"number"===typeof this.value&&(c=this.value.toString()),a.push(c));a.push("</"+this.name+">");return a.join("")}};var q=function(a,b){this.typeOf="SOAPResponse";this.status=a;this.headers=b.getAllResponseHeaders().split("\n");this.httpCode=b.status;this.httpText=
b.statusText;this.content=void 0===b.responseXML?b.responseText:b.responseXML;this.toString=function(){if("string"===typeof this.content)return this.content;if(d.isXMLDoc(this.content))return f.dom2string(this.content);throw Error("Unexpected Content: "+d.type(this.content));};this.toXML=function(){return d.isXMLDoc(this.content)?this.content:d.parseXML(this.content)};this.toJSON=function(){if(d.xml2json)return d.xml2json(this.content);n("jQuery.soap - Missing JQuery Plugin 'xml2json', info at: https://github.com/doedje/jquery.soap#dependencies")}},
