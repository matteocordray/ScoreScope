...
getPIColor(a)+';"></div></ons-col><ons-col class="piLegColText">'+c.name+"</ons-col></ons-row>")});$.each(h,function(a,b){c.push(b/g)});drawPIChart(l,c,k);loadGradingPeriods({GBID:a.GBID,courseID:a.courseID,termName:a.termName});d.hide();d.fadeIn(500)})}
